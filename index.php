        ...
        <header>
            ...
            <div class="header-bottom">
                ...
                <div class="logo">
                    ...
                    <a href="index.php"><img src="public/images/svg/logo.svg" width="180px" alt=""></a>
                </div>
        ...
        <section class="categories">
            <div class="cateDiv">
                ...
                <a href="./views/catogery.php">
                    <div>
                        <img src="./public/images/svg/deen.svg" width="50" alt="">
                    </div>
                    <h3 style="color: #5e2f26;">دين</h3>
                </a>
                <a href="./views/catogery.php">
                    <div>
                        <img src="./public/images/svg/tareek.svg" width="50" alt="">
                    </div>
                    <h3 style="color: #ea7726;">تاريخ</h3>
                </a>
                <a href="./views/catogery.php">
                    <div>
                        <img src="./public/images/svg/rwaiaat.svg" width="50" alt="">
                    </div>
                    <h3 style="color: #76689a;">روايات</h3>
                </a>
                <a href="./views/catogery.php">
                    <div>
                        <img src="./public/images/svg/seiasa.svg" width="50" alt="">
                    </div>
                    <h3 style="color: #bc4077;">سياسة</h3>
                </a>
                <a href="./views/catogery.php">
                    <div>
                        <img src="./public/images/svg/ekesad.svg" width="50" alt="">
                    </div>
                    <h3 style="color: #4389b6;">اقتصاد</h3>
                </a>
                <a href="./views/catogery.php">
                    <div>
                        <img src="./public/images/svg/game.svg" width="50" alt="">
                    </div>
                    <h3 style="color: #7db444;">طبخ</h3>
                </a>
                <a href="./views/catogery.php">
                    <div>
                        <img src="./public/images/svg/phone.svg" width="50" alt="">
                    </div>
